...
ROUTER_Grupos.get('/obtenerOne/:idGrupos', gruposController_1.obtenerOneGrupos);
ROUTER_Grupos.post('/agregar', gruposController_1.crearGrupos);
ROUTER_Grupos.put('/actualizar/:idGrupos', gruposController_1.actualizarGrupos);
ROUTER_Grupos.delete('/elimina/:idGrupos', gruposController_1.eliminarGrupos);
