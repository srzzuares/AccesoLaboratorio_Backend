...
ROUTER_DaPer.get('/obtenerOne/:idDatos_persona', datos_PersonaController_1.obtenerOneDaper);
ROUTER_DaPer.post('/agregar', datos_PersonaController_1.crearDaper);
ROUTER_DaPer.put('/actualizar/:idDatos_persona', datos_PersonaController_1.actualizarDaper);
ROUTER_DaPer.delete('/eliminar/:idDatos_persona', datos_PersonaController_1.eliminarDaper);
